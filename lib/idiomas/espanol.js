...
const smsRowner = () => { return `\`\`\`¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓨𝓞 𝓒𝓞𝓜𝓞 𝓒𝓡𝓔𝓐𝓓𝓞𝓡(𝓐) 𝓓𝓔 𝓑𝓞𝓣 𝓛𝓞 𝓟𝓤𝓔𝓓𝓔 𝓤𝓢𝓐𝓡!!\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓜𝓘 𝓒𝓡𝓔𝓐𝓓𝓞𝓡(𝓐) 𝓛𝓞 𝓟𝓤𝓔𝓓𝓔 𝓤𝓢𝓐𝓡!!\`\`\`` }//OWNER
const smsMods = () => { return `\`\`\`¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓜𝓞𝓓𝓔𝓡𝓐𝓓𝓞𝓡𝓔𝓢 𝓨 𝓜𝓘 𝓒𝓡𝓔𝓐𝓓𝓞𝓡(𝓐) 𝓛𝓞 𝓟𝓤𝓔𝓓𝓔𝓝 𝓤𝓢𝓐𝓡!!\`\`\`\`` }//MODERADORES
const smsPremium = () => { return `\`\`\`¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓔𝓢𝓣𝓐 𝓓𝓘𝓢𝓟𝓞𝓝𝓘𝓑𝓛𝓔 𝓟𝓐𝓡𝓐 𝓤𝓢𝓤𝓐𝓡𝓘𝓞𝓢 𝓟𝓡𝓔𝓜𝓘𝓤𝓜 𝓨 𝓜𝓘 𝓒𝓡𝓔𝓐𝓓𝓞𝓡(𝓐)!! 𝓟𝓐𝓡𝓐 𝓢𝓔𝓡 𝓟𝓡𝓔𝓜𝓘𝓤𝓜 𝓒𝓞𝓜𝓟𝓡𝓔 𝓤𝓝 𝓟𝓐𝓢𝓔 𝓤𝓢𝓐𝓝𝓓𝓞 #pass premium\`\`\`` }//USUARIOS PREMIUM
const smsGroup = () => { return `\`\`\`¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓢𝓔 𝓟𝓤𝓔𝓓𝓔 𝓤𝓣𝓘𝓛𝓘𝓩𝓐𝓡 𝓔𝓝 𝓖𝓡𝓤𝓟𝓞𝓢!!\`\`\`` }//PARA GRUPOS
const smsPrivate = () => { return `\`\`\`¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓢𝓔 𝓟𝓤𝓔𝓓𝓔 𝓤𝓣𝓘𝓛𝓘𝓩𝓐𝓡 𝓐𝓛 𝓟𝓡𝓘𝓥𝓐𝓓𝓞!!\`\`\`` }//AL PRIVADO
const smsAdmin = () => { return `\`\`\`¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓢Ó𝓛𝓞 𝓔𝓢 𝓟𝓐𝓡𝓐 𝓐𝓓𝓜𝓘𝓝𝓢!!\`\`\`` }//ADMINS
const smsBotAdmin = () => { return `\`\`\`¡¡𝓝𝓔𝓒𝓔𝓢𝓘𝓣𝓞 𝓢𝓔𝓡 𝓐𝓓𝓜𝓘𝓝 𝓟𝓐𝓡𝓐 𝓠𝓤𝓔 𝓟𝓤𝓔𝓓𝓐𝓢 𝓤𝓢𝓐𝓡 𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞!!\`\`\`` }//BOT CON ADMIN
const smsUnreg = () => { return `\`\`\`¡¡𝓝𝓔𝓒𝓔𝓢𝓘𝓣𝓐𝓢 𝓔𝓢𝓣𝓐𝓡 𝓡𝓔𝓖𝓘𝓢𝓣𝓡𝓐𝓓𝓞(𝓐) 𝓟𝓐𝓡𝓐 𝓤𝓢𝓐𝓡 𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞, 𝓔𝓢𝓒𝓡𝓘𝓑𝓔 #𝓿𝓮𝓻𝓲𝓯𝓲𝓬𝓪𝓻 𝓟𝓐𝓡𝓐 𝓡𝓔𝓖𝓘𝓢𝓣𝓡𝓐𝓡𝓣𝓔!!\`\`\`` }//VERIFICAR
const smsRestrict = () => { return `\`\`\`¡¡𝓔𝓢𝓣𝓔 𝓒𝓞𝓜𝓐𝓝𝓓𝓞 𝓔𝓢𝓣Á 𝓡𝓔𝓢𝓣𝓡𝓘𝓝𝓖𝓘𝓓𝓞 𝓟𝓞𝓡 𝓜𝓘 𝓒𝓡𝓔𝓐𝓓𝓞𝓡𝓐(𝓐)!!\`\`\`` }//RESTRINGIR COMANDO
...
//_allantilink.js
const smsTextoYT = () => { return '𝓒𝓡𝓔𝓐𝓓𝓞 𝓟𝓞𝓡 𝓜𝓞𝓝𝓞𝓥𝓐𝓝 𝓥𝓣𝓢'} 
...
//info-contacto.js
const smsContacto1 = () => { return ' Soy Monkey un Bot de WhatsApp dedicado en ayudar con lo que me pidas 😎'}
const smsContacto2 = () => { return 'Soy Owner de Monkey sí tienes alguna duda me la puedes decir ✌️'}
const smsContacto3 = () => { return '👑 Owner'}
const smsContacto4 = () => { return 'Contacto Oficial de Monkey 🐈'}
